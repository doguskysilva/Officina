...
| **12** | Glance Widgets — SizeMode, GlanceTheme, LazyColumn, LinearProgressIndicator, ActionCallback, ConfigActivity | [`39edae9`](../../commit/39edae9) | [lesson12.md](docs/lesson12.md) |
| **13** | Compose Previews — anotações customizadas, PreviewParameterProvider, multi-device, dark/dynamic colors, font scale | [`380bf8a`](../../commit/380bf8a) | [lesson13.md](docs/lesson13.md) |
